...
# 视频文件所在目录
VIDEO_DIR="/data/cwy/t2v_end/methods/mira/generation/nomember_sample_250_new_sample_2/samples"

# 输出基础目录
OUTPUT_BASE="/data/cwy/t2v_end/methods/mira/allframes/nomember_new_sample_2"
